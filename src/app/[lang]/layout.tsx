...
export default async function RootLayout({ children, params }: Props) {
 ...
 guarantees the page is still fully readable. */}
      ...
      <body>
        <a
          href="#main"
          className="sr-only focus:not-sr-only focus:fixed focus:start-4 focus:top-4 focus:z-[100] focus:bg-brand-gold focus:px-6 focus:py-3 focus:font-display focus:text-sm focus:font-bold focus:uppercase focus:tracking-[.08em] focus:text-brand-deep"
        >
