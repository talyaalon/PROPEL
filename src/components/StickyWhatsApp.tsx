...
export default function StickyWhatsApp({ message, label }: { message: string; label: string }) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-5 end-5 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-brand-accent text-brand-deep transition-all duration-300 ease-smooth active:scale-95 md:hidden ${
