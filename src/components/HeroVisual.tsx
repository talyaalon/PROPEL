    ...
    <div className="relative" aria-hidden="true">
      ...
      <div className="border border-brand-ink/15 bg-brand-deep">
        ...
        <div className="flex items-center gap-2 border-b border-brand-ink/15 px-4 py-3 sm:px-5">
          <span className="h-2.5 w-2.5 bg-brand-pink/70" />
          <span className="h-2.5 w-2.5 bg-brand-gold/70" />
          <span className="h-2.5 w-2.5 bg-brand-cyan/70" />
        ...
        <div className="space-y-5 p-5 sm:space-y-6 sm:p-7">
          ...
          <div className="flex items-center justify-between">
            <div className="h-3 w-20 bg-brand-gold" />
          ...
          <div className="space-y-2.5 pt-2">
            ...
            <div className="pt-2">
              <div className="h-7 w-28 bg-brand-gold" />
            </div>
          </div>
      ...
      <div className="absolute -bottom-6 end-3 border border-brand-gold bg-brand-void px-4 py-3.5 sm:end-6 sm:px-5">
        <div className="flex items-center gap-2.5 sm:gap-3">
          ...
          <Connector />
          <span className="flex h-8 w-8 items-center justify-center border border-brand-gold text-brand-gold">
