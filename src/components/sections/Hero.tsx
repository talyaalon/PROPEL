...
export default function Hero({ lang, dict }: Props) {
  ...
  return (
    <section className="relative overflow-hidden bg-brand-cream px-4 py-16 sm:px-6 sm:py-20 lg:px-8 lg:py-32">
      <div
      ...
      <div className="relative mx-auto max-w-7xl">
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-20">
          ...
          <div className={`flex flex-col gap-7 lg:gap-9 ${isRtl ? 'lg:order-2' : 'lg:order-1'}`}>
            ...
            {/* Subtitle */}
            <p className="animate-fade-up-delay-2 max-w-[500px] text-lg leading-[1.75] text-brand-steel sm:text-[19px]">
              {dict.subtitle}
            </p>
            ...
            <div className="animate-fade-in flex flex-col gap-3">
              ...
              <p className="text-[13px] text-brand-steel/90">{dict.cta_note}</p>
            </div>
          </div>
