...
const cardBase =
  'device-host group flex min-w-0 flex-col overflow-hidden border border-brand-line bg-brand-panel transition-all duration-500 ease-smooth hover:-translate-y-2 focus-within:-translate-y-2'
