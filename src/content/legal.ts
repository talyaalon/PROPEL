    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'ניווט מלא באמצעות מקלדת, כולל סימון ברור של הרכיב הממוקד',
          ...
          'הגדלת טקסט עד 200% ללא אובדן תוכן וללא גלילה אופקית. נמדד בכל העמודים, בשתי השפות, ברוחב 320 ו-375 פיקסלים',
    ...
    sections: [
      ...
      },
      {
        ...
        list: [
          ...
          'Text enlargement to 200% with no loss of content and no sideways scrolling. Measured on every page, in both languages, at 320px and 375px',
